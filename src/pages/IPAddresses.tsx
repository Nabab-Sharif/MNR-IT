...
const IPAddresses = () => {
  ...
  useReduxRows<IPAddress>("ip_addresses", setIpAddresses);
              ...
              <Card className="border-2 border-destructive print:border-black" id="ip-stats-details">
                <CardHeader className="flex flex-row items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-2 flex-wrap no-print w-full sm:w-auto">
                    <Input placeholder="Search..." value={statsSearch} onChange={(e) => setStatsSearch(e.target.value)} className="w-full sm:w-56" />
