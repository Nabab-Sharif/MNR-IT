...
const UserAssetCard = ({ asset, index = 0 }: UserAssetCardProps) => {
  ...
  // window.open throws "invalid URL" for custom protocols in some browsers —
  // use a temporary anchor click instead.
